...
class Advanced_Search extends Widget_Base {
	...
	public function search_setting() {
		...
		$this->add_control(
			...
			[
				'label'       => esc_html__( 'Keywords Length', 'essential-addons-for-elementor-lite' ),
				'type'        => Controls_Manager::NUMBER,
				'description' => esc_html__( 'Minimum number of characters for a keyword to be considered a popular search.', 'essential-addons-for-elementor-lite' ),
				'default'     => 4,
				'min'         => 1,
				'condition'   => [
					'show_popular_keyword' => 'yes',
