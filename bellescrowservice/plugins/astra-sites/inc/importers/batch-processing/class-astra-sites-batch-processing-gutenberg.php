...
if ( ! class_exists( 'Astra_Sites_Batch_Processing_Gutenberg' ) ) :
	...
	class Astra_Sites_Batch_Processing_Gutenberg {
		...
		public function import() {
			...
			$post_types = apply_filters( 'astra_sites_gutenberg_batch_process_post_types', array( 'page', 'wp_block', 'wp_template', 'wp_navigation', 'wp_template_part', 'wp_global_styles' ) );
			if ( defined( 'WP_CLI' ) ) {
